    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
        <div>
          ...
          <p
            className="reveal text-white/50 leading-relaxed mb-6"
            style={{ fontFamily: "'DM Sans', sans-serif" }}
          >
            I'm a self-taught full stack developer with a passion for building
            clean, functional web applications. I started learning web
            development on my own — from HTML and CSS all the way to building
            full stack apps with Laravel.
          </p>
          <p
            className="reveal text-white/50 leading-relaxed mb-6"
            style={{ fontFamily: "'DM Sans', sans-serif" }}
          >
            My background is in English Literature, which taught me how to
            communicate clearly — something I bring to my code and my work with
            clients.
          </p>
          <p
            className="reveal text-white/50 leading-relaxed"
            style={{ fontFamily: "'DM Sans', sans-serif" }}
          >
            I've built real projects — from a Laravel task tracker with
            authentication to a client portfolio site. Currently focused on
            deepening my React and Vue skills while continuing to build.
          </p>
        ...
        <div className="space-y-10">
          ...
          <div
            className="reveal pt-4 border-t"
